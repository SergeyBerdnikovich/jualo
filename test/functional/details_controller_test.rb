...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { ad_id: @detail.ad_id, address: @detail.address, description: @detail.description, name: @detail.name }
    end
  ...
  test "should update detail" do
    put :update, id: @detail, detail: { ad_id: @detail.ad_id, address: @detail.address, description: @detail.description, name: @detail.name }
    assert_redirected_to detail_path(assigns(:detail))
  end
