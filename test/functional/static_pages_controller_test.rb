...
class StaticPagesControllerTest < ActionController::TestCase
  ...
  test "should create static_page" do
    assert_difference('StaticPage.count') do
      post :create, static_page: { content: @static_page.content, locale_id: @static_page.locale_id, name: @static_page.name }
    end
  ...
  test "should update static_page" do
    put :update, id: @static_page, static_page: { content: @static_page.content, locale_id: @static_page.locale_id, name: @static_page.name }
    assert_redirected_to static_page_path(assigns(:static_page))
  end
